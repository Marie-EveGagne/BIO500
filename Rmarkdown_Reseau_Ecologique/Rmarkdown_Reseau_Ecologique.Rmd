...
Graphique 1 (Daphnée) : Préférence de collègue pour les étudiants. Comme illustré dans le graphique X, la pente positive nous indique que les étudiants de biologie semblent préférer travailler avec les mêmes étudiants. On peut également constater que.... Si on a une courbe qui va vers le haut, oui les étudiants préfèrent travailler avec les mêmes étudiants.
